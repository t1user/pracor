...
class Profile(models.Model):
    ...
    sex = models.CharField(
        "płeć", max_length=1, choices=SEX, default=None, null=True, blank=True
    )
    career_start_year = models.PositiveIntegerField(
        "rok rozpoczęcia kariery", choices=CAREER_YEAR, null=True, blank=True
    )
    education = models.CharField(
        "wykształcenie", max_length=2, choices=EDU, default=None, blank=True, null=True
    )
