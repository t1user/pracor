...
from .models import Benefit, Company, Interview, Position, Review, Salary
...
class InterviewForm(forms.ModelForm):
    ...
    # generated
    got_offer = forms.TypedChoiceField(
        required=True,
        label="Czy dostałaś/eś ofertę?",
